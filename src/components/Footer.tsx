...
export async function Footer() {
  ...
  return (
    <footer id="contact" className="mt-16 scroll-mt-20 border-t border-card-border">
      <div className="mx-auto max-w-6xl px-4 py-12 text-center sm:px-6 lg:px-8">
        <h2 className="text-3xl font-bold text-accent md:text-4xl">{contact.heading}</h2>
        <p className="mt-2 text-muted">{contact.body}</p>
        ...
        <p className="mt-8 text-center text-base text-muted">
          &copy; {new Date().getFullYear()} Ahmet Gür. Tüm hakları saklıdır.
        </p>
      </div>
    </footer>
  )
